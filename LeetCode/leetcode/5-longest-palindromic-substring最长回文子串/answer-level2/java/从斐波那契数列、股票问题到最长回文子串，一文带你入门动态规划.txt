...
第一行是 **下标** ,第二行是 **和** 。
![斐波那契数列](https://pic.leetcode-cn.com/09c14a64d0dbc9bec2785e46cd72282b006e5d33e5ee30f3f9d653cf602074a5.png)
<center>图1.1</center>

![状态转移方程](https://pic.leetcode-cn.com/6d8a45da844a2a4928275f1691aa648f1d411f9b6647d1e59dd1389179edf7ee.png)
<center>图1.2</center>
...
![动态规划表](https://pic.leetcode-cn.com/f37c552f50945a57e87a88cadb99d1d331d96fdd623ab9765f385aedd15535e4.png)
<center>（图1.3）</center>
<html><br></html>

现在有两种步数，分别是走```1```步跟走```2```步
如果每次都只走一步的话，到```N```的时候还是只有一种走法，所以在```dp[0]```的这一列都是```1```
![动态规划表](https://pic.leetcode-cn.com/d12ec5b763528d4bc995d23332f4aff8cc214fcd1a035e6f246dc08c311b34f0.png)
<center>（图1.4）</center>
<html><br></html>
...
```
OutPut:测试通过。
![测试结果](https://pic.leetcode-cn.com/c2ea02a45e853d518e4e8c0f8261b80c69029d29c5d9cbafd68aa5359cb0c2c1.png)
这个时候再回过头来看一下 **（图1.4）** ，可以明显的看到其实上下两列的结果一致，并不需要用二维数组来记录结果。
合并数组看一下：
![爬楼梯](https://pic.leetcode-cn.com/6534342652592b8f15e4c6d14d9d8f8b67b74cbb161f27eeec4f3709c5321fe3.png)
<center>（图1.6）</center>
<html><br></html>
...
![最小路径和](https://pic.leetcode-cn.com/369958cf0b0b8fbfe70bfcc0c0080fb788971ccc38a59cd73f50490d8c5485f2.png)
<center>（图2.1）</center>
<html><br></html>
...
![最小路径和](https://pic.leetcode-cn.com/f5a8c22bc0ae3915c9f4dd076c51d6f7ddf53b1cb3349abcce608df8cbb18bd0.png)
<center>（图2.2）</center>
<html><br></html>
...
```
#### 完整数组
![矩阵最小路径](https://pic.leetcode-cn.com/44d454eaedbe963c038351889c5640df45258d65a869887496c1937d99c4b233.png)
<center>（图2.3）</center>
<html><br></html>
...
![动态规划表](https://pic.leetcode-cn.com/7126c9b2554f2ab8988c163e304330145104b474252af29b1e7c2b7b68ad462e.png)
<center>（图3.1）</center>
<html><br></html>
...
![动态规划表](https://pic.leetcode-cn.com/f3662e430307ec82eeac72a989bb7052139af07aa4b018630e0a9ab0c7642f77.png)
<center>（图3.2）</center>
<html><br></html>
...
![在这里插入图片描述](https://pic.leetcode-cn.com/ba7fff3ef52fafcb196b589c4dc32318d9e43edaf4fa9e98b574bd4c0c8c2d56.png)
<center>（图3.5）</center>
<html><br></html>
...
![动态规划表](https://pic.leetcode-cn.com/9f3b6e533aea4b5e1937e7ee30541c7bb43a7aec4878dfcc79389505672b0d73.png)
<center>（图3.6）</center>
<html><br></html>
...
5. 一开始不赚不亏设置为0。
![动态规划表](https://pic.leetcode-cn.com/032cb916ee01b35109e3b8dd4e9b9989f15ffb3074ebfc175c8452b4144ac42d.png)
#### 代码片段
```java
