「design Twitter」不仅题目本身很有意思，而且把合并多个有序链表的算法和面向对象设计（OO design）结合起来了，很有实际意义，本文就带大家来看看这道题。
...
![tweet](https://pic.leetcode-cn.com/d254a5924db29a8151b0b80fc7bfe75f696ebfbe654ffc239d110e30e24273df-file_1562814337475)
...
![User](https://pic.leetcode-cn.com/7cd6d9108f470e3251f580891e8fbfb62b60d4907761eeade5b0c9bde566c9e0-file_1562814335470)
...
实现合并 k 个有序链表本身就是一道算法题目，[力扣题目链接](https://leetcode-cn.com/problems/merge-k-sorted-lists/)。需要用到优先级队列（Priority Queue），这种数据结构是「二叉堆」最重要的应用。
...
![gif](https://pic.leetcode-cn.com/1889e8aed5a0815055a2b89dbad954a521cfa07717eec816f762be048b6677e2-file_1562814335465)
...
![design](https://pic.leetcode-cn.com/9a24f9afb09b0ab59136a1e411da6f543c0b29f18b26a96d2aec6f045700ff64-file_1562814335471)

我们解决的问题应该只能算 Timeline Service 模块的一小部分，功能越多，系统的复杂性可能是指数级增长的。所以说合理的顶层设计十分重要，其作用是远超某一个算法的。

最后，Github 上有一个优秀的开源项目，专门收集了很多大型系统设计的案例和解析，而且有中文版本，上面这个图也出自该项目。对系统设计感兴趣的读者可以[点击这里](https://github.com/donnemartin/system-design-primer/blob/master/README-zh-Hans.md)查看。
