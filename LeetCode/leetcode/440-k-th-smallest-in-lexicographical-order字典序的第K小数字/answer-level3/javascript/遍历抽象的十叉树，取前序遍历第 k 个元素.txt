在 https://blog.csdn.net/FJJ543/article/details/81908992 中我们可以看到，关于字典序的问题就是用十叉树来抽象地做，而我们实际上并没有在代码中用到树数据结构，而是抽象地有一棵树，主要关注某一个节点有多少个子节点。

我加了完善的注释，使用了比较符合领域的变量名，希望对你有帮助：
