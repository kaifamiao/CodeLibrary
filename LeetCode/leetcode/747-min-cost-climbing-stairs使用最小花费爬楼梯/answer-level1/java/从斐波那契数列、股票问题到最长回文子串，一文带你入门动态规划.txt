...
第一行是 **下标** ,第二行是 **和** 。
![斐波那契数列](https://pic.leetcode-cn.com/3c5456ac39dc16108a725532babc59067f7ab05fcbd0558657ae1e99da7fcec5.png)
<center>图1.1</center>

![状态转移方程](https://pic.leetcode-cn.com/456da5e3bbc584ad57e799287d6e18de0765e15bac6806fd4ab45ece8bce2d6b.png)
<center>图1.2</center>
...
![动态规划表](https://pic.leetcode-cn.com/e95aceb29719d52bde85ee2461724a0ffd6d049013ef3393f3e61c4215d5c205.png)
<center>（图1.3）</center>
<html><br></html>

现在有两种步数，分别是走```1```步跟走```2```步
如果每次都只走一步的话，到```N```的时候还是只有一种走法，所以在```dp[0]```的这一列都是```1```
![动态规划表](https://pic.leetcode-cn.com/6fbff577dddbecd804c46c6173330f181188b0362e44884c417b7d2e2f423471.png)
<center>（图1.4）</center>
<html><br></html>
...
```
OutPut:测试通过。
![测试结果](https://pic.leetcode-cn.com/248831eba6ebc8b8d5e31ac623a0594383ff8bf1b5702e16d2e10bbdcece1230.png)
这个时候再回过头来看一下 **（图1.4）** ，可以明显的看到其实上下两列的结果一致，并不需要用二维数组来记录结果。
合并数组看一下：
![爬楼梯](https://pic.leetcode-cn.com/e8ca1fbf198f16c6359941238d88e8294d12ce4d5f3652aed15dfed0066e388c.png)
<center>（图1.6）</center>
<html><br></html>
...
![最小路径和](https://pic.leetcode-cn.com/85f336e83ac8bf8db843f789e2fd034cf8bac333adba25e9feda00b51e456bd6.png)
<center>（图2.1）</center>
<html><br></html>
...
![最小路径和](https://pic.leetcode-cn.com/7b108a69066a6cd1958e4737ac7c64dfe2fb25ac9250a450beade145006c52c3.png)
<center>（图2.2）</center>
<html><br></html>
...
```
#### 完整数组
![矩阵最小路径](https://pic.leetcode-cn.com/f2ecf927e737653aee787176e623345548b8f87799916f64da5a989012356026.png)
<center>（图2.3）</center>
<html><br></html>
...
![动态规划表](https://pic.leetcode-cn.com/bd69573f5479ae436268b8ad0237fe240eba6a0c015eb420dfd522de6f216ead.png)
<center>（图3.1）</center>
<html><br></html>
...
![动态规划表](https://pic.leetcode-cn.com/3aacb80a5be64802f7a65259e5ea8d8b6f799a3661d7581777f02d0d96da8c77.png)
<center>（图3.2）</center>
<html><br></html>
...
![在这里插入图片描述](https://pic.leetcode-cn.com/08b23f116ba397204fb81e27e988b7d5f8af236d1cdaf571a2bba614bb57d77e.png)
<center>（图3.5）</center>
<html><br></html>
...
![动态规划表](https://pic.leetcode-cn.com/6f25f8b9435cde4fe8e0e7e1784e6a52e0ca226467c2a0652fac2a852a2c1d22.png)
<center>（图3.6）</center>
<html><br></html>
...
5. 一开始不赚不亏设置为0。
![动态规划表](https://pic.leetcode-cn.com/24a9675ffafa83747fa578bea84c69303e8f8e53577f3dfd9768a26352ca52aa.png)
#### 代码片段
```java
